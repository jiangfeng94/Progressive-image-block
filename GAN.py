            ...
            for i,(imgs,_) in enumerate(self.data):
                ...
                if i % 20 == 0:
                    if not os.path.exists('../output'):
                        os.mkdir('../output')
                    #torchvision.utils.save_image(imgs, '../output/%d_in.png' % (epoch * len(self.data) + i), nrow=4, normalize=True)
                    #torchvision.utils.save_image(crop_imgs, '../output/%d_c1.png' % (epoch * len(self.data) + i), nrow=4, normalize=True)
